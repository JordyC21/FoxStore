using Foxstore.Helpers;
using Foxstore.Logica;
...
namespace Foxstore.Controllers
{
    public class TiendaController : Controller
    {
        ...
        {
            List<Compra> oLista = CarritoLogica.Instancia.ObtenerCompra(oUsuario.IdUsuario);

            oLista = (from c in oLista
                      select new Compra()
                      {
                          IdCompra = c.IdCompra, // Agregamos el Id de la compra para vincularlo con la descarga de factura
                          Total = c.Total,
        ...
        {
            List<Compra> oLista = CarritoLogica.Instancia.ObtenerCompra(oUsuario.IdUsuario);
            return oLista.FirstOrDefault(c => c.IdCompra == idCompra);
        }
    }
}
